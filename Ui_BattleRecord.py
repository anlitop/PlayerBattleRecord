...
class Ui_Battle(object):
    ...
    def retranslateUi(self, Battle):
        ...
        self.select_battle_path.setText(_translate("Battle", "PushButton"))
        self.label.setText(_translate("Battle", "提取哪种玩家战斗记录"))
        self.select_account_btn.setText(_translate("Battle", "PushButton"))
        ...
        self.pushButton.setText(_translate("Battle", "PushButton"))
